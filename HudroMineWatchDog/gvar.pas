...
var
  ...
  EmailSender,EmailReceiver,EMailHost,EMailUsername,EMailPassword:string;
  EMailPort:Integer;
  SendEmailOnNotStartMiner,SendEmailOnGPUFail,EMailTested,StartMinerOnStartWatchDog,Started:Boolean;
  StartMinerLatencyInSec,MinerStartFailTimer:Integer;
  CloseMinerOnCloseWatchDog,AlwaysCheckMinerLunched,NormalClose,DoNotCheckMiner :Boolean;
  ErrorsForRestartMiner:Integer; // Количество ошибок для рестарта майнера
  ProcessParseLog, ShowingListOfError:Boolean;
implementation
...
begin
  ...
  IdMessage1.Recipients.EMailAddresses := EmailReceiver;
  ...
  IdSMTP.Host := EMailHost;
  IdSMTP.Port := EMailPort;
  // обычно при использование ssl 495, 587 или стандартный 25
  IdSMTP.Username := EMailUsername;
  IdSMTP.Password := EMailPassword;
